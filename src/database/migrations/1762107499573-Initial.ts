...
export class Initial1762107499573 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            CREATE TYPE "public"."server_role_permission_action_enum" AS ENUM('delete', 'create', 'read', 'update', 'manage')
        `);
    await queryRunner.query(`
            CREATE TYPE "public"."server_role_permission_subject_enum" AS ENUM(
                'ServerConfig',
                'Channel',
                'Invite',
                'Message',
        ...
        `);
    await queryRunner.query(`
            CREATE TABLE "server_role_permission" (
                "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
                "action" "public"."server_role_permission_action_enum" NOT NULL,
                "subject" "public"."server_role_permission_subject_enum" NOT NULL,
                "serverRoleId" uuid NOT NULL,
                "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
                CONSTRAINT "UQ_241e1e6dabe71175f3bbe04d863" UNIQUE ("serverRoleId", "action", "subject"),
                CONSTRAINT "PK_2fbaa042aa7fc14dbc93337dc37" PRIMARY KEY ("id")
            )
        `);
    await queryRunner.query(`
            CREATE TABLE "server_role" (
                ...
                "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
                CONSTRAINT "PK_77fbb52d800cdca8c698bc0ddcc" PRIMARY KEY ("id")
            )
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
            CREATE TABLE "bot" (
                ...
                "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
                CONSTRAINT "UQ_b423b82835dfb7fd8d850b2cfda" UNIQUE ("name"),
    ...
    await queryRunner.query(`
            CREATE TABLE "server_role_members_user" (
                "serverRoleId" uuid NOT NULL,
                "userId" uuid NOT NULL,
                CONSTRAINT "PK_8fbdc54227b52a90c2943464ab3" PRIMARY KEY ("serverRoleId", "userId")
            )
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_7ba90ade3419699107a9b2a3412" FOREIGN KEY ("serverRoleId") REFERENCES "server_role"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
    await queryRunner.query(`
            ALTER TABLE "server_role"
            ADD CONSTRAINT "FK_1e89da148a3d3b91e71eddc5ad5" FOREIGN KEY ("serverId") REFERENCES "server"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
            ALTER TABLE "poll_action_role"
            ADD CONSTRAINT "FK_c2e7a2156840005cbd863cd2d1e" FOREIGN KEY ("serverRoleId") REFERENCES "server_role"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
            ALTER TABLE "message"
            ADD CONSTRAINT "FK_62102187d4652d128e25058c4b2" FOREIGN KEY ("botId") REFERENCES "bot"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
    await queryRunner.query(`
            ALTER TABLE "message"
    ...
    await queryRunner.query(`
            ALTER TABLE "server_role_members_user"
            ADD CONSTRAINT "FK_f63712bbbf85cf2d7974fea3da1" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            ALTER TABLE "message" DROP CONSTRAINT "FK_62102187d4652d128e25058c4b2"
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            ALTER TABLE "poll_action_role" DROP CONSTRAINT "FK_c2e7a2156840005cbd863cd2d1e"
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            ALTER TABLE "server_role" DROP CONSTRAINT "FK_1e89da148a3d3b91e71eddc5ad5"
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            DROP TABLE "server_role"
        `);
    await queryRunner.query(`
            DROP TABLE "server_role_permission"
        `);
    await queryRunner.query(`
            DROP TYPE "public"."server_role_permission_subject_enum"
        `);
    await queryRunner.query(`
