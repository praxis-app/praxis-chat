...
import { MultiServerSupport1765754853130 } from './migrations/1765754853130-MultiServerSupport';
...
export const dataSource = new DataSource({
  ...
  migrations: [Initial1762107499573, MultiServerSupport1765754853130],
});
